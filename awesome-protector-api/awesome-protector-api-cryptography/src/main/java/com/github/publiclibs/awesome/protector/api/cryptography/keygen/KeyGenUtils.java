...
public class KeyGenUtils {
	...
	public static void main(final String[] args) throws NoSuchAlgorithmException, InvalidAlgorithmParameterException {
		final AsymmetricCipherKeyPair pair = generateED25519Keys();
		System.err.println(pair);
		final KeyPair pair2 = generateCURVE25519Keys();
		System.err.println(pair2);
	}
}
